...
- 2026-06-08: Re-fixed teleprompter ON/OFF (conditional render in App.tsx when enabled). Scrolling reliably continues after app close via AppState listener. Updated histories.
