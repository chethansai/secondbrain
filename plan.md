...
- 2026-06-11: **USER CUSTOMIZABLE TELEPROMPTER REQUIREMENTS ADDED**. Added PART 9 to project requirements: Teleprompter must support full user customization including (1) Multi-select category filtering, (2) Note selection mode (All/Starred/Selected Only with manual note picker), (3) Duration presets (1s-24h + Unlimited), (4) Live countdown display, (5) Auto-stop on duration expiry, (6) Auto-rotation of notes (5sec-5min intervals), (7) Status display showing current category/note/remaining/speed. Requirements added to plan.md and CLAUDE.md. Git workflow executed.
