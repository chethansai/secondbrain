...
object TeleprompterSettings {
    ...
    fun update(context: Context, isRunning: Boolean? = null, text: String? = null, speed: Float? = null, textSize: Float? = null, durationMs: Long? = null, startTimeMs: Long? = null, position: Float? = null) {
