...
function createStyles(colors: typeof import('../../shared/design/tokens').colors) {
  return StyleSheet.create({
    ...
    summaryTileBlue: { backgroundColor: colors.cardTintLavender, borderColor: colors.linkBlue },
    ...
    input: { minHeight: 44, borderWidth: 1, borderColor: colors.hairlineStrong, borderRadius: rounded.md, backgroundColor: colors.canvas, color: colors.ink, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, ...typography.bodySm },
    ...
    scheduledNotification: { backgroundColor: colors.cardTintLavender, borderColor: colors.linkBlue },
